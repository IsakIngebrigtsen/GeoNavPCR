...
file_list = get_files(0, 23, 'Round3')  # the files from the 10th file and 5 files on # Take file nr. 17 next.
full_pc = np.zeros(3)
...
for files in file_list:  # For loop that goes through the PCAP files, and the corresponding laz files.
    ...
    laz_file_dovre = "C:\\Users\\isakf\\Documents\\1_Geomatikk\\Master\\Data\\Dovre\\pointcloud\\1024x20_20211020_" + files + ".laz"
    las = laspy.read(laz_file_dovre)
    xyz = las.xyz
...
source_filename = 'pros_data\\dovre_full_source_pc.npy'
