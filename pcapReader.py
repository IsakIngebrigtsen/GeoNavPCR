...
import numpy as np
"""
I have stolen this code e teapod github.
"""
...
class PcapReader:
    ...
    def remove_vehicle(self, frame, cloud=None):
        ...
        vw = 0.7
        vl = 2.2
        return cloud[((frame[:, 0] > 0.2) | (frame[:, 0] < -vl)) | ((frame[:, 1] > vw) | (frame[:, 1] < -vw)) | (
                    (frame[:, 2] > 0.3) | (frame[:, 2] < -2))]
...
if __name__ == "__main__":
    pcap_path = 'C:\\Users\\isakf\\Documents\\1_Geomatikk\\Master\\Data\\OS-1-128_992035000186_1024x10.pcap'
    metadata_path = 'C:\\Users\\isakf\\Documents\\1_Geomatikk\\Master\\Data\\OS-1-128_992035000186_1024x10.json'
    import sys
    sys.path.append('C:\\Users\\isakf\Documents\\1_Geomatikk\\Master\\Data\\data')
